...
tk.Button(button_frame, text='Vendas', **button_style).pack(pady=10)
...
# RODAPÉ
footer = tk.Label(menuInicial, text="© 2025 MELLK - Todos os direitos reservados", font=('Arial', 10), fg='white', bg='#1A3C34')
